...
public class GeneralExceptionHandler {
	...
	public ResponseEntity<StandardError> operationNotPermitted(OperationNotPermittedException e,
	...
	public ResponseEntity<StandardError> invalidAttributes(MethodArgumentNotValidException e,
			HttpServletRequest request) {
	...
	public ResponseEntity<StandardError> entityDuplicateValues(SQLIntegrityConstraintViolationException e,
			HttpServletRequest request) {
		StandardError error = new StandardError();
		error.setTimestamp(Instant.now());
